...
package Kernel::GenericInterface::Transport::HTTP::REST_RS;
...
sub RequesterPerformRequest {
    ...
    # RS ==================================================
    for my $Header ( keys %{ $Self->{TransportConfig}{Config}{Headers} } ) {
        $Headers->{$Header} = $Self->{TransportConfig}{Config}{Headers}{ $Header };       
    }
    # /RS =================================================
    ...
    # RS
    $Result->{_RequestData} = $RequestData;
